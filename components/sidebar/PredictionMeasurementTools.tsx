...
interface PredictionMeasurementToolsProps {
  activeTool: ToolType;
  onActivate: (tool: ToolType) => void;
}

const PredictionMeasurementTools: React.FC<PredictionMeasurementToolsProps> = ({ activeTool, onActivate }) => {
  const tools: { icon: React.ReactNode, id: ToolType }[] = [
    { icon: <LayoutTemplate size={24} />, id: 'long_short' as ToolType },
    { icon: <Activity size={24} />, id: 'info' as ToolType },
  ];
...
export default PredictionMeasurementTools;
